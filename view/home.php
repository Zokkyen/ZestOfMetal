...
<main>
    ...
    <div class="container-fluid homePage">
        ...
        <div id="carouselExampleControls" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-touch="false">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img id="wallOne"alt="Wallpaper 1">
                </div>
                <div class="carousel-item">
                    <img id="wallTwo" alt="Wallpaper 2">
                </div>
                <div class="carousel-item">
                    <img id="wallThree" alt="Wallpaper 3">
                </div>
                <div class="carousel-item">
                    <img id="wallFour" alt="Wallpaper 4">
                </div>
            </div>
        </div>
        ...
        <div class="welcomeLast text-center p-1">
            <div class="w-75 h-50 d-flex justify-content-center align-items-center">
